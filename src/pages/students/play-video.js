...
export default class PlayVideo extends Component {
    ...
    render() {
        return (
            <AppLayout pageName={`${this.props.tn ? (this.props.tn == "lib" ? "Library" : "My Subjects") : "My Subjects"} ${this.state.video ? ("| Play Video - " + this.state.video.title) : ""}`}>
                <Row className="mt-2 ml-0 mr-0">
                    <a href={this.props.tn ? (this.props.tn == "lib" ? "/students/library" : "/students/my-subjects") : "/students/my-subjects"} className={styles.back}><FontAwesomeIcon icon={faArrowLeft} size="1x" />&nbsp;&nbsp;Back</a>
                </Row>
                <Row className="mt-2 ml-0 mr-0">
                    {
                        this.state.video ?
