...
export default class ContactUs extends Component {
    render() {
        return(
            <AppLayout pageName="Contact Us">
                <Container>
                    <Row as="div" style={{height: "auto", paddingTop: "5%", paddingBottom: "3%"}}>
                        <Col md="7" className={styles.items_right} as="div">
                            <img src="images/image5.PNG" className={styles.contact_image} alt="Contact Image" />
                        </Col>
                        <Col md="5" as="div">
                            <div className={styles.big_text}>Contact Us</div>
                            <div className={styles.get_in_touch_text}>Get in touch with our ever ready customer agents.</div>
                            <div className={styles.bold_description} style={{paddingTop: 12}}>Phone call and Whatsapp (Lagos)</div>
                            <div className={styles.description_content}>+234-7040-326-266</div>
                            <div className={styles.bold_description}>Phone call and Whatsapp (Oyo)</div>
                            <div className={styles.description_content}>+234-7040-326-266</div>
                            <div className={styles.bold_description}>Phone call and Whatsapp (Ogun)</div>
                            <div className={styles.description_content}>+234-7040-326-266</div>
                            <div className={styles.bold_description}>General Enquiries</div>
                            <div className={styles.description_content}>info@reatentapp.com</div>
                            <div className={styles.bold_description}>Customer Care Service</div>
                            <div className={styles.description_content}>support@reatentapp.com</div>
